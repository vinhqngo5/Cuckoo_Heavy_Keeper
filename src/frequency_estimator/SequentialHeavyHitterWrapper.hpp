...
template <typename FrequencyEstimator, typename T> class SequentialHeavyHitterWrapper {
  ...
  public:
    unsigned long total;
    SequentialHeavyHitterWrapper(FrequencyEstimator &frequency_estimator, float theta, size_t max_heavy_hitters = 0);
...
#include "SequentialHeavyHitterWrapper.ipp"